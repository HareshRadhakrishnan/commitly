...
```
RESEND_API_KEY=re_...
RESEND_FROM=LogLogic <onboarding@resend.dev>   # Optional. For testing, use onboarding@resend.dev
...
4. For production: verify your domain in Resend and set `RESEND_FROM` to e.g. `LogLogic <notifications@yourdomain.com>`
